...
The official stock firmware for both models is based on the [Marlin firmware](https://marlinfw.org/) v2.?.?.  
  
As Anycubic didn't release the source code yet, I can't give you any further insights about specific settings yet.  
